  ...
  if (loading) return (
    <div className="min-h-screen bg-gray-50">
      <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)]">
        ...
        <h2 className="text-2xl font-bold text-gray-700">Loading Zootopia Appointments...</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-red-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-red-600 uppercase tracking-wider">Payment</th>
