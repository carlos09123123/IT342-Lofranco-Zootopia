    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                if (!token) {
                    toast.error("Please log in to access your Zootopia profile.");
                    navigate("/login");
                    return;
                }
    ...
    if (!user) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
                ...
                <Link
                    to="/login"
                    className="bg-red-600 text-white px-6 py-2 rounded-full font-medium hover:bg-red-700"
                >
                    Login
                </Link>
            </div>
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border overflow-hidden">
                    <div className="bg-red-50 p-8">
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            <div className="w-24 h-24 rounded-full bg-white flex items-center justify-center border-4 border-red-200 shadow-md">
                            ...
                            <div className="mt-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            disabled={!isEditMode}
                                            className={`mt-1 w-full p-2 border rounded focus:ring-red-500 focus:border-red-500 ${!isEditMode ? 'bg-gray-50' : ''}`}
                                        />
                                    </div>
                                    <div>
                                ...
                                {isEditMode && (
                                    <button
                                        ...
                                        disabled={loading}
                                        className="mt-4 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 disabled:bg-red-400"
                                    >
