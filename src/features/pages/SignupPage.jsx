    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 flex items-center justify-center p-4 md:p-8">
        <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
          <div className="hidden md:block bg-red-50 rounded-2xl overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-red-100/50 to-transparent"></div>
            <img
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.firstName ? 'border-red-500' : ''}`}
                      value={firstName}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.lastName ? 'border-red-500' : ''}`}
                      value={lastName}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.username ? 'border-red-500' : ''}`}
                    value={username}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.email ? 'border-red-500' : ''}`}
                    value={email}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.password ? 'border-red-500' : ''}`}
                    value={password}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className={`rounded-lg focus:ring-red-500 focus:border-red-500 ${errors.confirmPassword ? 'border-red-500' : ''}`}
              ...
              <div className="flex justify-center">
                <Button 
                  type="button"
                  variant="outline" 
                  className="rounded-lg hover:border-red-600 hover:text-red-600"
