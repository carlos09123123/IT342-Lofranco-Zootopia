      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="ghost" size="icon" className="text-gray-600 hover:bg-red-50">
            <Link to="/cart" className="text-gray-600 inline-flex items-center justify-center p-2 rounded-full hover:text-red-600 transition-colors duration-200">
          ...
          {isLoading ? (
            ...
            <div className="relative avatar-dropdown">
              ...
              >
                <Avatar className="h-9 w-9 flex items-center justify-center bg-red-100 text-red-600 border-2 border-red-200">
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 border border-red-100">
                  <div className="px-4 py-2 text-sm text-gray-700 border-b border-red-100">
                    <div className="font-medium text-red-600">Signed in as</div>
            ...
            <Button className="hidden md:flex bg-red-600 hover:bg-red-700 text-white transition-colors duration-200 shadow-sm hover:shadow" asChild>
              <Link to="/login">Login</Link>
            </Button>
          )}

          {/* Mobile Menu Button */}
          <Button variant="ghost" size="icon" className="md:hidden text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
