            ...
            <div className="mt-6">
              <Breadcrumb className="justify-center">
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/services" className="font-medium text-red-600">
                      Services
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl font-bold mb-4">A happy pet is always clean and well-cared for!</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-2">Hear from our satisfied customers at Zootopia</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-shadow">
        ...
        <section className="py-16 bg-red-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900">Ready to Book a Service?</h2>
              <p className="text-gray-600 mt-2 mb-6">Schedule an appointment for your pet today at Zootopia</p>
              <Button size="lg" className="rounded-full bg-red-600 hover:bg-red-700" asChild>
                <Link to="/services/appointment">Book an Appointment</Link>
              </Button>
            </div>
          </div>
