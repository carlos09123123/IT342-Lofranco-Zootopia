  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1">
        <section className="relative bg-gradient-to-r from-red-50 to-red-100/30 overflow-hidden">
          <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 space-y-6 text-center md:text-left mb-10 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                <Button size="lg" variant="outline" className="rounded-full hover:border-red-600 hover:text-red-600">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
                      ...
                      <div className="flex items-center">
                        {Array.from({ length: totalPages }).map((_, index) => (
                          <button
                            ...
                            className={`mx-1 w-8 h-8 rounded-full ${currentPage === index ? 'bg-red-600 text-white' : 'bg-gray-200 hover:bg-red-200'}`}
                          >
                            {index + 1}
                          </button>
                        ))}
            ...
            <div className="text-center mt-12">
              <Button variant="outline" size="lg" className="rounded-full hover:border-red-600 hover:text-red-600" asChild>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div className="p-6">
                  ...
                  <Button className="bg-red-600 hover:bg-red-700"><Link to="/services/appointment">Book Now</Link></Button>
                </div>
              </div>
