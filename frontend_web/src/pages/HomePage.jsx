  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1">
        ...
        <section className="relative bg-gradient-to-r from-red-600/10 to-red-500/5 overflow-hidden">
          <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 space-y-6 text-center md:text-left mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900">
                Where Pets Find <span className="text-red-600">Paradise</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                <Button size="lg" variant="outline" className="rounded-full border-red-600 text-red-600 hover:bg-red-50">
                  <Link to="/services">Our Services</Link>
                </Button>
              </div>
            </div>
            <div className="md:w-1/2 relative">
              <div className="aspect-[5/3] w-full max-w-lg mx-auto overflow-hidden rounded-2xl shadow-xl ring-2 ring-red-200">
                <img
                  src={happypets}
                  alt="Happy pets"
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
              ...
              <>
                <div className="relative">
                  ...
                  {getPaginatedProducts().map((product) => (
                    <div key={product.productID} className="bg-white rounded-xl shadow-sm border border-red-100 p-6 transition-all hover:shadow-md hover:border-red-300">
            ...
            <div className="text-center mt-12">
              <Button variant="outline" size="lg" className="rounded-full border-red-600 text-red-600 hover:bg-red-50" asChild>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-red-50 p-6 rounded-xl border border-red-100">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-red-800">Happy Customer {i}</p>
